...
// PreviewV1alpha1Client is used to interact with features provided by the preview.jenkins.io group.
type PreviewV1alpha1Client struct {
	restClient rest.Interface
}

func (c *PreviewV1alpha1Client) Previews(namespace string) PreviewInterface {
	return newPreviews(c, namespace)
}
